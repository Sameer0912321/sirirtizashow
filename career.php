...
<?php
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $insertion = "INSERT INTO hiring VALUES(null,'$fullname','$email','$phone','$address','$position','$price','$resume','$coverletter','$edu','$linkedin','$startdate','$reference')";
...
<form method="post">
    ...
    <div class="form-row">
        <div class="form-group">
            <label for="position">Enter Your Monthly Price In PKR</label>
