...
<a href="index.php">
    ...
    <div class="container">
        ...
        <br>
            <div style="display:flex;flex-direction:column; height:10em; justify-content-space-between">
               <?php echo"
                <a href='editprofile.php' style='margin: bottom 2em;;' class='btn '>Edit Profile</a>
                ";?>
                <?php echo"
    ...
    while($row = mysqli_fetch_assoc($res)){
        echo "
            <div class='card'>
                ...
                <p><strong>Resume:</strong> <a href='#'>{$row['resume']}</a></p>
